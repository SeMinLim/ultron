// Auto-generated rule patterns from rule.txt
// Generated by parse_rules.py
...
typedef struct {
    UInt#(16) ruleId;
    UInt#(16) port;
    UInt#(8)  protocol;  // 6=TCP, 17=UDP
    UInt#(8)  direction; // 0=request, 1=response
    UInt#(16) offset;
    UInt#(16) patternLen;
...
// Pattern data (first 32 bytes of each pattern for quick matching)
